                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Taxe Gopass</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                
                                <li><routerLink class="mini-sub-pro" to="/Dashboard">Dashboard  </routerLink><a title="Dashboard v.1" ><span class="mini-sub-pro"></span></a></li>
                                <li><routerLink to="/agent">Agent </routerLink><a title="Product List"><span ></span></a></li>
                                <li><a title="Product Edit" href="product-edit.html"><span class="mini-sub-pro">Passagers</span></a></li>
                                <li><a title="Product Detail" href="product-detail.html"><span class="mini-sub-pro">Paiement</span></a></li>
                                <li><a title="Product Cart" href="product-cart.html"><span class="mini-sub-pro">Vols</span></a></li>
                                <li><a title="Product Payment" href="product-payment.html"><span class="mini-sub-pro">Avions</span></a></li>
                                <li><a title="Analytics" href="analytics.html"><span class="mini-sub-pro">Compagies</span></a></li>                        
                            </ul>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Bar Charts" href="bar-charts.html"><span class="mini-sub-pro">Statisaques</span></a></li>
                                <li><a title="Line Charts" href="line-charts.html"><span class="mini-sub-pro">Paiement</span></a></li>
                                <li><a title="Area Charts" href="area-charts.html"><span class="mini-sub-pro">Passagers</span></a></li>
                                <li><a title="Rounded Charts" href="rounded-chart.html"><span class="mini-sub-pro">Operations</span></a></li>
                        ...
                        <li id="removable">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Password Recovery" href="password-recovery.html"><span class="mini-sub-pro">Resset Password</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Dashboard Two</h2>
												<p>Welcome to site Go pass for th air plane of goma <span class="bread-ntd">Taxe Go Pass</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
